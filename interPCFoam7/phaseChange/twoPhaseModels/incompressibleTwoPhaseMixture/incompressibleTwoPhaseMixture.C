...
(
    ...
    ,const word& alpha1Name		//add 22.01.03
)
:
...
//----------------------add 21.12.27 -----------------------------//
    ...
    //add ci
    C1_("C", dimSpecificHeatCapacity, nuModel1_->viscosityProperties()),
    C2_("C", dimSpecificHeatCapacity, nuModel2_->viscosityProperties()),

//----------------------------------------------------------------//
    U_(U),
    phi_(phi),

    alpha1_(U_.db().lookupObject<const volScalarField> (alpha1Name)),	//add 21.01.03
